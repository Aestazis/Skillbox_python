...
print('три песни звучат', round(halo + enjoy + clean), 'минут')
...
blue = violator_songs_dict['Policy of Truth']
print('А другие три песни звучат', round(sweet + policy + blue), 'минут')
